...
public unsafe class Aloalo_Bombs : SplatoonScript
{
    ...
    public override void OnSetup()
    {
        for (int i = 0; i < 3; i++)
        {
            Controller.RegisterElementFromCode($"Bomb{i}", "{\"Name\":\"\",\"type\":1,\"Enabled\":false,\"radius\":12.0,\"color\":855638015,\"thicc\":4.0,\"refActorObjectID\":21845,\"refActorComparisonType\":2,\"Filled\":true}");
        }
    }
